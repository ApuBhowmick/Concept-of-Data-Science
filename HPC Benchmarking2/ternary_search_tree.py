...
def main():
    ...
    # === Define File Paths ===
    insert_words_path = Path("/user/leuven/375/vsc37516/concept_of_data_science/data/search_trees/insert_words.txt")
    not_insert_words_path = Path("/user/leuven/375/vsc37516/concept_of_data_science/data/search_trees/not_insert_words.txt")
    corncob_path = Path("/user/leuven/375/vsc37516/concept_of_data_science/data/search_trees/corncob_lowercase.txt")
